...
import com.giraffe.mizanapp.catalogue.CatalogueDefect.DuplicateDisplayPosition
import com.giraffe.mizanapp.catalogue.CatalogueDefect.DuplicateEffectiveFrom
import com.giraffe.mizanapp.catalogue.CatalogueDefect.DuplicateSectionOrder
import com.giraffe.mizanapp.catalogue.CatalogueDefect.DuplicateTaskSlug
import com.giraffe.mizanapp.catalogue.CatalogueDefect.DuplicateVersionNumber
import com.giraffe.mizanapp.catalogue.CatalogueDefect.InvalidOccurrenceLimit
import com.giraffe.mizanapp.catalogue.CatalogueDefect.MalformedCatalogue
import com.giraffe.mizanapp.catalogue.CatalogueDefect.MalformedSlug
import com.giraffe.mizanapp.catalogue.CatalogueDefect.NoCatalogue
import com.giraffe.mizanapp.catalogue.CatalogueDefect.NonPositivePoints
import com.giraffe.mizanapp.catalogue.CatalogueDefect.SectionCompositionMismatch
import com.giraffe.mizanapp.catalogue.CatalogueDefect.UnknownSection
import com.giraffe.mizanapp.catalogue.CatalogueDefect.UnreachableSchedule
import com.giraffe.mizanapp.catalogue.CatalogueDefect.UserAuthoringAffordance
import com.giraffe.mizanapp.catalogue.CatalogueDefect.VersionOrderMismatch
...
class CatalogueValidatorTest {
    ...
    fun `rule 6 - duplicate display position within a section is rejected`() {
        ...
        assertEquals("adhkar", defect.sectionId)
        assertEquals(1, defect.position)
        assertEquals(listOf("adhkar-1", "adhkar-2"), defect.slugs)
    }

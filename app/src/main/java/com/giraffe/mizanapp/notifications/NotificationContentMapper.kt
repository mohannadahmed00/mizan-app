...
fun NotificationContent.render(): RenderedNotification = when (category) {
    ...
    NotificationCategory.STREAK_AT_RISK -> {
        val current = bodyArgs["current"] ?: "0"
        RenderedNotification("Keep your rhythm going", "One task keeps your $current-day streak going.")
    }
